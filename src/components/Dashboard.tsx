...
import { UserProfile, Order, Product, LogisticsJob, getUserSubscriptionInfo, AFKET_SUPPORT } from '../types';
...
export default function Dashboard({ user, setCurrentTab }: DashboardProps) {
  ...
  return (
    <div className="py-6 space-y-8 font-sans">
      {/* 14-Day Free Trial & Deactivation Alert Notification Banner */}
      {!subInfo.isPaid && (
                ...
                <div className="space-y-1">
                  <div className="flex flex-wrap items-center gap-2">
                    <h4 className="text-sm font-black text-gray-900">
                      {subInfo.isTrialActive ? '14-Day Free Trial Active' : 'Trial Period Expired — Action Required'}
                    </h4>
                  ...
                  <p className="text-xs text-gray-700 leading-relaxed font-medium">
                    {subInfo.isTrialActive ? (
                      <>
                        Your account is currently running on a <strong>14-day free trial</strong> with limited access to  trade listings and freight operations.
                        <span className="text-amber-900 font-bold block mt-0.5">
                          ⚠️ Please note: If your subscription fee is not paid after the 14-day trial ends, this account will be automatically deactivated.
                        </span>
                      </>
                    ) : (
                      <>
                        ...
                        Please settle your subscription to keep your account active and prevent interruption.
                      </>
                    )}
                  </p>
                </div>
