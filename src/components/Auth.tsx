...
export default function Auth({ onAuthSuccess, initialError, isRecoveryMode }: AuthProps) {
  ...
  // Process Free Registration with 14-Day Free Trial
                ...
                <div className="bg-[#FAF9F6] border border-gray-100 rounded-2xl p-5 space-y-4 mb-6">
                  ...
                  <div className="flex items-start space-x-3.5">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <span className="text-xs text-gray-500 font-medium block">The link will automatically verify your account and open your trading dashboard with your 14-day free trial active!</span>
                    </div>
                  </div>
                </div>
                        ...
                        >
                          ...
                          <div className="space-y-2 pt-2">
                            <button
                              ...
                              disabled={loading}
                              className="w-full bg-[#365314] hover:bg-[#283e0f] text-white font-bold py-3.5 px-4 rounded-xl shadow-md transition flex items-center justify-center space-x-2 text-sm cursor-pointer"
                            >
                              {loading ? (
                                <>
                                  <span className="inline-block animate-spin border-2 border-white border-t-transparent rounded-full h-4 w-4"></span>
