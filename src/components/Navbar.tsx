            ...
            >
              ...
              <div className="flex items-center space-x-1.5 mt-0.5">
                ...
                {subInfo.isTrialActive && (
                  <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-lime-100 text-lime-900 border border-lime-300 flex items-center gap-0.5" title={`${subInfo.daysRemaining} days left in 14-day free trial`}>
