    ...
    try {
      ...
      const paychanguRes = await triggerPayChanguPayment({
        ...
        customization: {
          ...
          description: `Payment for ${effectiveFee.toLocaleString()} MWK ${planTitle}`
        }
      });
      ...
      setPaymentSuccessMsg(`${selectedPlan === 'annual' ? 'Annual' : 'Monthly'} subscription fee of ${effectiveFee.toLocaleString()} MWK successfully verified! (Ref: ${finalRef})`);
      setTimeout(() => {
          ...
          <div className="space-y-1.5">
            ...
            <h3 className="text-lg font-black text-[#1F2937]">
              {subInfo.isPaid
                ...
                : subInfo.isTrialActive
                ? `1-Month Free Account Usage Active (${subInfo.daysRemaining} ${subInfo.daysRemaining === 1 ? 'day' : 'days'} remaining)`
        ...
        <div className="space-y-6">
            ...
            <div className="border-t border-gray-800 pt-4 mt-6 space-y-2 text-xs font-mono relative">
              ...
              <div className="flex justify-between">
                ...
                <span className={`font-bold ${subscriptionStatus === 'paid' ? 'text-emerald-400' : subInfo.isTrialActive ? 'text-amber-400' : 'text-rose-400'}`}>
                  {subscriptionStatus === 'paid' ? 'PAID / ACTIVE' : subInfo.isTrialActive ? `NOT PAID (1-MO TRIAL - ${subInfo.daysRemaining}D)` : 'NOT PAID (PAYMENT DUE)'}
                </span>
              </div>
              <div className="flex justify-between">
          ...
          <div className="bg-[#ECFCCB]/70 text-[#365314] rounded-3xl p-6 border border-[#D9F99D] text-left space-y-3">
            ...
            <p className="text-xs leading-relaxed opacity-95 font-medium">
              Registration on AFKET is 100% free with a 1-month trial (30 days). Settle your subscription to maintain active verified listings:
            </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 pt-1">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <button
                          type="button"
                          onClick={() => setPaymentRef(generatePayChanguTxRef('TX-AFKET'))}
